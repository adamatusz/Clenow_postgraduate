...
```{r}
W20L <- read.csv("f:/R_nauka/etfw20l_pl_d.csv")
...
chartSeries(W20L)
write.zoo(W20L, file = "f:/R_nauka/W20L.csv", sep = ",")

DAX <- read.csv("f:/R_nauka/etfdax_pl_d.csv") 
...
chartSeries(DAX)
write.zoo(DAX, file = "f:/R_nauka/DAX.csv", sep = ",")

SPY_1 <- read.csv("f:/R_nauka/etfsp500_pl_d.csv") 
...
chartSeries(SPY_1)
addSMA(200)
write.zoo(SPY_1, file = "f:/R_nauka/SPY_1.csv", sep = ",")
